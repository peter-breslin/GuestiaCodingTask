...
{
    public class GroupFilterReportWriterTestData
    {
        public static IEnumerable<object[]> Write_GuestiaFormatProvider_FormattedReportInDebugWindow =>
new List<object[]>
{
               new object[] {
                   "Non Registered Guests, Grouped By GuestGroup",
                   GetGuestList()
               }
};


        public static IEnumerable<object[]> Write_UseStandardFormatProvider_FormattedReport =>
new List<object[]>
{
               new object[] {
                   "Non Registered Guests Grouped By GuestGroup",
