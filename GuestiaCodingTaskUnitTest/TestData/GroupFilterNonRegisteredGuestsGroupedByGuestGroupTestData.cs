...
using GuestiaCodingTaskUnitTest.Helpers;


namespace GuestiaCodingTaskUnitTest.TestData
{
    public class GroupFilterNonRegisteredGuestsGroupedByGuestGroupTestData
    {
        public static IEnumerable<object[]> Query_NonRegisteredGuestsGroupedByGuestGroup_EmptyIQueryGroup =>
        new List<object[]>
        {
               new object[] {
                   null,
        ...
        public static IEnumerable<object[]> Query_NonRegisteredGuestsGroupedByGuestGroup_IQueryGroup =>
         new List<object[]>
         {
               new object[] {
                   GetGuestList(),
        ...
        #region GetGuestList
        static List<Guest> GetGuestList()
        {
